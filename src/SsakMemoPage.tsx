...
export const ssakMemoCopy: Record<Locale, SsakMemoCopy> = {
  ko: {
    ...
    pageDescription: "위젯과 제어 센터에서 한 번 탭해 녹음하거나 입력하고, 메모를 기기 안과 날짜별 Markdown으로 보관합니다.",
    ...
    footer: "떠오른 순간을 가장 짧은 동선으로 붙잡는 로컬 메모",
  },
  en: {
    pageTitle: "싹 메모 | Capture It the Moment It Appears",
    pageDescription: "Open voice or text capture in one tap and keep every note locally with daily Markdown output.",
    kicker: "APP NODE 01-F",
    signal: "INSTANT CAPTURE / LOCAL FIRST",
    ...
    footer: "The shortest path from thought to a local note",
  },
  ja: {
    pageTitle: "싹 메모 | 思いついた瞬間、すぐ記録",
    pageDescription: "ウィジェットやコントロールセンターからワンタップで音声・テキスト入力を始め、メモを端末内と日別Markdownに残します。",
    kicker: "APP NODE 01-F",
    signal: "INSTANT CAPTURE / LOCAL FIRST",
    ...
    footer: "思いついた瞬間を最短ルートでつかまえるローカルメモ",
  },
};
