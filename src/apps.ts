...
export const productApps: ProductApp[] = [
  ...
  },
  {
    id: "ringtone",
    order: "08",
    code: "CHOOSE / TRIM / RING",
    icon: "app-icons/ringtone.png",
    version: "1.0",
    platforms: ["iOS 26+"],
    accent: "cobalt",
    status: "live",
    content: {
      ko: {
        displayName: "벨소리로",
        tagline: "좋아하는 소리의 한 구간을 벨소리로",
        description: "내가 가진 오디오 파일에서 마음에 드는 구간을 최대 30초까지 고르고, 들어 보고, 벨소리로 내보냅니다. 편집과 저장은 iPhone 안에서 이뤄집니다.",
        features: ["파형으로 고르는 최대 30초", "반복 미리 듣기와 페이드", "기기 안에서 편집하고 공유"],
      },
      en: {
        displayName: "Make It a Ringtone",
        tagline: "Turn your favorite part of a sound into a ringtone",
        description: "Choose up to 30 seconds from an audio file you own, listen back, and export it as a ringtone. Editing and storage stay on your iPhone.",
        features: ["Choose up to 30 seconds on the waveform", "Loop previews and fades", "Edit on your device and share"],
      },
      ja: {
        displayName: "Hiorio 着信音メーカー",
        tagline: "好きな音の、その部分だけを着信音に",
        description: "自分が持っている音声ファイルから好きな部分を最大30秒まで選び、試聴して着信音として書き出します。編集も保存もiPhoneの中で行います。",
        features: ["波形で選ぶ最大30秒", "ループ試聴とフェード", "端末内で編集して共有"],
      },
    },
