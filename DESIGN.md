...
- 첫 화면은 `감성 메시지를 남기는 경험`과 `상대의 홈 화면 위젯을 꾸미는 경험`을 동등한 핵심으로 선언하고, 실제 iOS 위젯 미리보기를 증거로 보여 준다.
- `40자`, `배경 14종`, `도착 효과 12종`과 Small/Medium/Large 미리보기를 마음이 한 장면이 되는 흐름으로 연결한다.
